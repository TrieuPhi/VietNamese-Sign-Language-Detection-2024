...
class Application:
    ...
    def __init__(self):
        ...
        self.T.config(text="CHUYỂN ĐỔI NGÔN NGỮ SANG KÝ HIỆU VĂN BẢN", font=("Times New Roman", 30, "bold"))
        ...
        self.T1.config(text="Ký Tự :", font=("Times New Roman", 30, "bold"))
        ...
        self.T3.config(text="Từ Ghép :", font=("Times New Roman", 30, "bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x=10, y=700)
        self.T4.config(text="Đề Xuất :", fg="red", font=("Times New Roman", 30, "bold"))
